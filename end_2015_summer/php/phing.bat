...
SET phpCli=D:\Users\conor\Desktop\coplex\2d\end_2015_summer\php\.\php.exe
...
"%phpCli%" -d html_errors=off -qC "D:\Users\conor\Desktop\coplex\2d\end_2015_summer\php\pear\phing.php" %*
GOTO :EOF
