...
GOTO doshift
:noshift
D:\Users\conor\Desktop\coplex\2d\end_2015_summer\php\.\php.exe -q -d output_buffering=1 -d include_path="\xampp\php\pear" \xampp\php/Text/Highlighter/generate.bat %MHL_PARAMS%
